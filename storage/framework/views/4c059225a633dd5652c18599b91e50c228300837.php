      ...
      <?php if($diseases): ?>
        ...
        <ul class="mt-3 pt-3 border-top">
          <?php $__currentLoopData = $diseases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disease): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li><b><?php echo e(\App\Http\Controllers\Patient\DiseasesController::getLocalName($disease)); ?></b></li>
...
<?php /**PATH /home/a/alexstrilby/ayrveda/resources/views/doctor/regular/patients/info.blade.php ENDPATH**/ ?>