                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4 justify-content-end m-0">
                                <form action="<?php echo e(route('cart.proceed')); ?>" method="Post">
                                    <?php echo csrf_field(); ?>
                                    <button class="btn btn-primary"><?php echo e(__('cart.proceed')); ?></button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\docure\resources\views/patient/cart.blade.php ENDPATH**/ ?>