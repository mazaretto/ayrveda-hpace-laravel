                ...
                <div class="card-body d-flex flex-wrap">
                    <div class="row">
                            ...
                            <div class="clinic-details my-2">
                                <ul class="clinic-gallery">
                                    <?php $__currentLoopData = explode(',', $medicine->gallery); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="<?php echo e(Storage::url($image)); ?>" data-fancybox="gallery">
                        ...
                        <div class="col-12 col-md-8 mt-5 mt-md-0">
                            ...
                            <p><b>Manufacturer:</b> <?php echo e($medicine->manufacter); ?></p>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\docure\resources\views/store/medicine-single.blade.php ENDPATH**/ ?>