        ...
        <div class="col-md-8 col-12">
          <nav aria-label="breadcrumb" class="page-breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?php echo e(route('doctors-list')); ?>">Doctors List</a></li>
              <li class="breadcrumb-item active" aria-current="page">Doctor Search</li>
            </ol>
          </nav>
          <h2 class="breadcrumb-title">Doctor Search</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="search-box mb-2">
            <form action="<?php echo e(route('search-doctor')); ?>" method="Get">
              <div class="form-group search-info">
                <input type="text" name="s" class="form-control" placeholder="Search for Our Doctors" value="<?php echo e($search); ?>">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/alexstrilby/ayrveda/resources/views/doctors-find.blade.php ENDPATH**/ ?>