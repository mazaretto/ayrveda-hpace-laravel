        ...
        <div class="row">
          <div class="col">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?php echo e(route('admin.patients-list')); ?>">Patients</a></li>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <p class="col-sm-10"><?php echo e($user->phone??null); ?></p>
                      </div>
                      <div class="row">
                        ...
                        <table class="table table-hover table-center mb-0">
                          ...
                          <?php $__currentLoopData = $user->medicalRecord()->get()->sortByDesc('date')??null; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                              ...
                              <td><a href="#"><?php echo e($row->file_name); ?></a></td>
                              <td>
                                <h2 class="table-avatar">
                                  <a href="<?php echo e(route('admin.doctor-profile', ['id' => $row->from_id])); ?>"
                                     class="avatar avatar-sm mr-2">
                                    <img class="avatar-img rounded-circle"
                                         src="<?php echo e($photo); ?>"
                                         alt="User Image">
                                  </a>
                                  <a href="<?php echo e(route('admin.doctor-profile', ['id' => $row->from_id])); ?>"><?php echo e($name); ?></a>
                                </h2>
                              </td>
                              <td class="text-right">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/alexstrilby/ayrveda/resources/views/admin/patient/show-profile.blade.php ENDPATH**/ ?>