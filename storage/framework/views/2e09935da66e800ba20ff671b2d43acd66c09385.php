<?php $__env->startSection('content'); ?>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form class="card" action="<?php echo e(route('admin.medicine-edit-submit')); ?>" method="Post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <img class="avatar avatar-medicine" style="cursor: pointer" onclick="$('#fileUpload').click()" src="<?php echo e(Storage::url($medicine->image)); ?>" alt="">
                            ...
                            <div class="row my-2">
                                ...
                                <h4>Address</h4>
                                <div class="mb-1 col-12 d-flex">
                                    <input type="text" name="manufacter_address" class="form-control" placeholder="" value="<?php echo e($medicine->manufacter_address??null); ?>">
                                </div>

                                <h4>Phone Number of Firm</h4>
                                <div class="mb-1 col-12 d-flex">
                                    <input type="text" name="manufacter_phone" class="form-control" placeholder="" value="<?php echo e($medicine->manufacter_phone??null); ?>">
                                </div>
                            </div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/alexstrilby/ayrveda/resources/views/admin/medicine/medicine-edit.blade.php ENDPATH**/ ?>