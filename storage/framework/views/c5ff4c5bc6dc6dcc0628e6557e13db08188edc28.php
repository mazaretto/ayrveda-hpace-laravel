                        ...
                        <div class="profile-info-widget">
                          ...
                          <div class="profile-det-info">
                            ...
                            <div class="patient-details">
                              <h5 class="mb-0"><i
                                  class="fas fa-map-marker-alt"></i> <?php echo e($location??trans('regular.loc_unknown')); ?>

                              </h5>

                              <a href="<?php echo e(route('chat', ['id' => 'P'.$patient->id])); ?>" class="btn btn-lg btn-white msg-btn mt-2 w-100">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/alexstrilby/ayrveda/resources/views/doctor/my-patients.blade.php ENDPATH**/ ?>