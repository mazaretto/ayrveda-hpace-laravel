    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Medicine List</h3>
                        <ul class="breadcrumb">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-end">
                            <a href="#" class="btn btn-primary text-light" data-toggle="modal"
                               data-target="#add_medicine">Add Medicine</a>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\docure\resources\views/admin/medicine/medicine-list.blade.php ENDPATH**/ ?>