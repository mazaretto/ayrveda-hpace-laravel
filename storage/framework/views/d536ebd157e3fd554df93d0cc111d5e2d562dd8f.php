...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="card services-card">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-0">
                                    <label class="h5">Specialization </label>
                                            ...
                                            <div class="row form-row education-cont">
                                                <div class="col-12 col-md-10 col-lg-11">
                                                    <div class="row form-row">
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="form-group">
                                                                <label class="h5">College/Institute</label>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="form-group">
                                                                <label class="h5">Year of Completion</label>
                                                                <div class="cal-icon">
                                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="row form-row experience-cont">
                                                <div class="col-12 col-md-10 col-lg-11">
                                                    <div class="row form-row">
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="form-group">
                                                                <label class="h5">Designation</label>
                                                                <input type="text" class="form-control"
                                        ...
                                        <?php $__currentLoopData = unserialize($profile->membership); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row form-row membership-cont">
                                                <div class="col-12 col-md-10 col-lg-5">
                                                    <div class="form-group">
                                                        <label class="h5">Memberships</label>
                                                        <input type="text" class="form-control"
                                    ...
                                    <?php if(($profile->registrations??null) !== null): ?>
                                        <?php $__currentLoopData = unserialize($profile->registrations); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registrations): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row form-row reg-cont">
                                                <div class="col-12 col-md-5">
                                                    <div class="form-group">
                                                        <label class="h5">Registrations</label>
                                                        <input type="text" class="form-control"
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\docure\resources\views/doctor/doctor-profile-settings.blade.php ENDPATH**/ ?>