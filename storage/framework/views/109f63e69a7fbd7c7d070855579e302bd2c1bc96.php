    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row mb-3">
                        <button class="btn btn-success" onclick="getDiseases(this)">Сохранить</button>
                        <button class="btn btn-warning text-light ml-2" onclick="clearDiseases(this)">Отменить
                            изменения
                        </button>
                    </div>
                    <?php if($diseases): ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <a href="javascript:void(0)" class="mt-1" onclick="addDiseaseCategory(this)">Add Disease
                        Category</a>
                </div>
            </div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\domains\docure\resources\views/admin/diseases-list.blade.php ENDPATH**/ ?>