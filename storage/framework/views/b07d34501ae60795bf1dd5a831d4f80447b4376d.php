            ...
            <div class="card-body">
              <form action="<?php echo e(route('patient.diseases-set')); ?>" method="Post">
                ...
                <?php if($diseases): ?>
                  <?php $__currentLoopData = $diseases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disease): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="disease-category">
                      <h4 class="diseases-title" onclick="collapse(this)"><i
                        ...
                        <?php echo e(\App\Http\Controllers\Patient\DiseasesController::getLocalName($disease->title)); ?>
                      ...
                      <ul class="diseases-list">
                        <?php $__currentLoopData = $disease->diseases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <li>
                            <label>
                              <?php if(in_array($row, $user_diseases)): ?>
                              <input name="data[]" type="checkbox" value="<?php echo e($row); ?>" checked>
                              <?php ($end_list[] = \App\Http\Controllers\Patient\DiseasesController::getLocalName($row)); ?>
                                <?php echo e(end($end_list)); ?>

                              <?php else: ?>
                                <input name="data[]" type="checkbox" value="<?php echo e($row); ?>">
                                <?php echo e(\App\Http\Controllers\Patient\DiseasesController::getLocalName($row)); ?>
                  ...
                  <div class="mt-3">
                    <p><b><?php echo e(__('patient_nav.diseases')); ?>:</b> <?php echo e(implode(', ', $end_list)); ?></p>
                  </div>
                <?php else: ?>
                  <h2>Not seted</h2>
                <?php endif; ?>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/alexstrilby/ayrveda/resources/views/patient/patient-diseases.blade.php ENDPATH**/ ?>