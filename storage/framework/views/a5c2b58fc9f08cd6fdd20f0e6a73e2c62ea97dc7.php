                                ...
                                <div class="col-12 d-flex">
                                  ...
                                  <div class="table-responsive mx-5">
                                    <table class="table table-hover table-center mb-0">
                                      <thead>
                                      <tr>
                                        <th class="py-0 px-2" style="width: 33.33333%"><?php echo e(__('cart.price')); ?></th>
                                        <th class="py-0 px-2" style="width: 33.33333%"><?php echo e(__('cart.quantity')); ?></th>
                                        <th class="py-0 px-2" style="width: 33.33333%"><?php echo e(__('cart.total_price')); ?></th>
                                      </tr>
                                      </thead>
                                      <tbody>
                                      <tr>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/a/alexstrilby/ayrveda/resources/views/patient/purchase-history.blade.php ENDPATH**/ ?>