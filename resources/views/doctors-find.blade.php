        ...
        <div class="col-md-8 col-12">
          <nav aria-label="breadcrumb" class="page-breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{route('doctors-list')}}">Doctors List</a></li>
          ...
          <div class="search-box mb-2">
            <form action="{{route('search-doctor')}}" method="Get">
              <div class="form-group search-info">
                <input type="text" name="s" class="form-control" placeholder="Search for Our Doctors" value="{{$search}}">
