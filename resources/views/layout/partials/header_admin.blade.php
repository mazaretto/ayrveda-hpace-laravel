  ...
  <div class="header">
    ...
    <div class="header-left">
      <a href="{{route('admin.dashboard')}}" class="logo">
        <h3 style="word-break: break-all;margin-top: 0.4em;">{{env('APP_NAME')}}</h3>
      </a>
    ...
    <!-- User Menu -->
      ...
      <li class="nav-item dropdown has-arrow">
        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
          <span class="user-img admin"><img class="rounded-circle" src="{{$photo}}" width="31" alt="Ryan Taylor"></span>
        </a>
