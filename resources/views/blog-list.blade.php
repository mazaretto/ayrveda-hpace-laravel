					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-12">
							...
							<div class="blog">
								...
								<h3 class="blog-title"><a href="blog-details">{{env('APP_NAME')}} – Making your clinic painless visit?</a></h3>
								...
								<div class="card-body">
									<ul class="latest-posts">
										<li>
											...
											<div class="post-info">
												<h4>
													<a href="blog-details">{{env('APP_NAME')}} – Making your clinic painless visit?</a>
												</h4>
												<p>4 Dec 2019</p>
											</div>
										</li>
							...
							<div class="card tags-widget">
								...
								<div class="card-body">
									<ul class="tags">
										...
										<li><a href="#" class="tag">{{env('APP_NAME')}}</a></li>
									</ul>
								</div>
							</div>
							<!-- /Tags -->
